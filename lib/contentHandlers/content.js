...
exports.contentHandlerCreator = function (config) { return __awaiter(_this, void 0, void 0, function () {
    var _this = this;
    var docs, docsArray, tags, categories, draftRegex, getFilename, parseFile, getContent, filterDocuments;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                parseFile = function (filename) { return __awaiter(_this, void 0, void 0, function () {
                    var id, creation, mtime, contents, frontmatter, markdown, data;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
            ...
            case 1:
                ...
                docsArray = Object.values(docs).sort(function (a, b) {
                    var aDate = a.attributes.date.getTime();
                    var bDate = b.attributes.date.getTime();
                    if (aDate < bDate) {
                        return 1;
                    }
                    else if (aDate > bDate) {

...
exports.MarssContext = React.createContext(null);
/**
...
exports.createMarss = function (options, socket) { return __awaiter(_this, void 0, void 0, function () {
    var reducers, initialState, _a, actions, media, tagsReducer, _b, categoriesReducer, _c, combinedReducers, deepFreeze_1, original_1;
        ...
        switch (_d.label) {
            ...
            case 6:
                if (options.functionality.media) {
                    media = media_1.createMedia(socket, options);
                }

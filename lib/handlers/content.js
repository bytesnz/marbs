 ...
 */
var getIdFromFilename = function (filename) { return filename.replace(/\.md$/, ''); };
exports.contentHandlerCreator = function (config) { return __awaiter(_this, void 0, void 0, function () {
    var _this = this;
    var docs, docsArray, tags, categories, draftRegex, getFilename, parseFile, getContent, removeDocument, addDocument, mdFilesGlob, getDocument, filterDocuments;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                parseFile = function (documentPath, keepBody) { return __awaiter(_this, void 0, void 0, function () {
                    var id, filename, mtime, contents, frontmatter, markdown, data;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                            ...
                            case 2:
                                ...
                                if (config.functionality.tags && data.tags) {
                                    data.tags = data.tags.map(function (tag) { return utils_1.iderise(tag); });
                                    if (!data.draft) {
                                ...
                                if (config.functionality.categories && data.categories) {
                                    data.categories = data.categories.map(function (category) {
                                        if (typeof category === 'string') {
                                            return utils_1.iderise(category);
                                        }
                                        else {
                                            return category.map(function (subCategory) { return utils_1.iderise(subCategory); });
                                        }
                                    });
                                    if (!data.draft) {
                ...
                getContent = function (filename) { return __awaiter(_this, void 0, void 0, function () {
                    var contents, data;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                ...
                addDocument = function (path) { return __awaiter(_this, void 0, void 0, function () {
                    var id, markdown, creation, index;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                id = getIdFromFilename(path);
                                return [4 /*yield*/, parseFile(path)];
                            case 1:
                                markdown = _a.sent();
                                creation = !removeDocument(path);
                                docs[id] = markdown;
            ...
            case 1:
                ...
                return [4 /*yield*/, glob(mdFilesGlob, {
                        ...
                        return Promise.all(files.map(function (file) { return addDocument(file); }));
                    })];
            case 2:
                // Parse all the markdown files in the source folder
                _a.sent();
                _a.label = 3;
            case 3:
                getDocument = function (id) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1: return [4 /*yield*/, getContent(filename)];
                            case 2:
                                contents = _a.sent();
                                return [2 /*return*/, {
                                        id: id,
                ...
                return [2 /*return*/, {
                        ...
                        events: {
                            content: function (socket, uri) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, getDocument(uri)];
                                        case 1:
                                            content = _a.sent();
                                            socket.emit('content', {
                                                results: content,

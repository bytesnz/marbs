...
ava_1.default('createTagsActions() should listen for tags events', function (t) {
...
ava_1.default('tags event listener should dispatch a set tags action when get results', function (t) {
    var count = {
        test: 1,
        second: 5
    };
...
ava_1.default('tags event listener should dispatch an set tags action with the error when gets an error', function (t) {
...
ava_1.default('setTags() should dispatch a set tags action', function (t) {
    var count = {
        test: 1,
        second: 5
    };
...
ava_1.default('tagsError() should dispatch a set tags action with an error', function (t) {
    var error = {
        message: 'Error',
        code: 500
    };
...
ava_1.default('fetchTags() should emit a tags event to fetch tags', function (t) {
...
ava_1.default('fetchTags() does not emit an event if tags are already being fetched', function (t) {
    t.context.state = {
        tags: null
    };
    t.context.actions.fetchTags();
